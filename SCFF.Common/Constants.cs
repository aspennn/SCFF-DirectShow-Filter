...
public static class Constants {
  ...
  /// Normal: ウィンドウの最大高さ
  public const double NormalMaxHeight = 565.0;
  /// Compact: ウィンドウの最大高さ
  ...
  /// Normal: ウィンドウの初期高さ
  public const double NormalDefaultHeight = 565.0;

  /// NormalLayout: ウィンドウの初期幅
  public const double NormalLayoutDefaultWidth = 730.0;
  /// NormalLayout: ウィンドウの初期高さ
  public const double NormalLayoutDefaultHeight = 565.0;
  ...
  public const double CompactLayoutDefaultHeight = 565.0;
